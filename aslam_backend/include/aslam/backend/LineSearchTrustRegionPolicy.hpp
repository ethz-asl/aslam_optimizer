...
{
 public:
  LineSearchTrustRegionPolicy();
  // scale: How much to scale the step when an iteration fails.
  LineSearchTrustRegionPolicy(double scale);
  ...
  virtual std::string name() const { return "line_search"; }
