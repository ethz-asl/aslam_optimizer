...
void exportSampler()
{
  ...
  class_<SamplerBase::Statistics, boost::noncopyable>("SamplerStatistics", init<>("Statistics(): Default constructor"))
      ...
      .def_readwrite("nIterationsThisRun", &SamplerBase::Statistics::nIterationsThisRun)
      .def_readwrite("nSamplesAcceptedThisRun", &SamplerBase::Statistics::nSamplesAcceptedThisRun)
  ;
